...
function logPlayerAiContextSummary(summary: PlayerAiContextDebugSummary): void {
  ...
  console.info('[player-ai] Context summary:', {
    ...
    profileFound: summary.profileFound,
    heightFound: summary.heightFound,
    weightFound: summary.weightFound,
    ageFound: summary.ageFound,
    positionsFound: summary.positionsFound,
